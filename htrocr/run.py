...
from linesegmentation.PreciseLineSegmenter import PreciseLineSegmenter
from linesegmentation.HBLineSegmenter import HBLineSegmenter
...
class NHMDPipeline(object):
    def __init__(self, save_images=False, out_dir='./out', out_type='txt', testing=False):
        ...
        with open("pipeline_config.json", "r", encoding="utf-8") as f:
            data = json.load(f)
        data["baseline_model_weight_path"] = pkg_resources.resource_filename('linesegmentation', 'predictor/net/default.pb')
